...
[System.Serializable]
public class Item_list_Soup
{
    public Item_list_Soup(string _Type, string _Name, string _Explanation)
    {
...
public class Soup_DataBase : MonoBehaviour
{
    public TextAsset ItemDatabase;
    public List<Item_list_Soup> aiItemList, SoupAnswer_ItemList;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < line.Length; i++)
        {
            ...
            aiItemList.Add(new Item_list_Soup(row[0], row[1], row[2] ));
        }
    ...
    void Load()
    {
        ...
        SoupAnswer_ItemList = JsonConvert.DeserializeObject<List<Item_list_Soup>>(jdata);
    }
