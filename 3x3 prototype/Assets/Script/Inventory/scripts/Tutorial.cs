...
public class Tutorial : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        //{
        //    TutorialImage[i] = Tutorial_Image[i].GetComponent<Image>().sprite;
        //}
            ...
            case 0:
                {
                    ...
                    SpaceButton.GetComponent<Image>().sprite = TutorialImage[0];

                    if ( GameManager.instance.GetTutorialClear() == false)
                    {
                        if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                        {
                            SpaceButton.GetComponent<Image>().sprite = TutorialImage[1];
            ...
            case 1:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[2];
            ...
            case 2:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[3];
            ...
            case 3:
                {
                    //Tutorial_Image[3].SetActive(true);
                    time += 1;
                    if (time>100)// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[4];
            ...
            case 4:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[5];
            ...
            case 5:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[6];
            ...
            case 6:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[7];
            ...
            case 7:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[8];
            ...
            case 8:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[9];
            ...
            case 9:
                {
                    ...
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[10];
            ...
            case 10:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[11];
            ...
            case 11:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[12];
            ...
            case 12:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[13];
            ...
            case 13:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[14];
            ...
            case 14:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[15];
            ...
            case 15:
                {
                    ...
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[16];
            ...
            case 16:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[17];
            ...
            case 17:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[18];
            ...
            case 18:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.E))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[19];
            ...
            case 19:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[20];
            ...
            case 20:
                {
                    ...
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[21];
            ...
            case 21:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[22];
            ...
            case 22:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[23];
            ...
            case 23:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[24];
            ...
            case 24:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[25];
            ...
            case 25:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[26];
            ...
            case 26:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[27];
            ...
            case 28:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        ...
                        //Tutorial_Image[28].SetActive(true);
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[28];
                        step++;
                    }
                }
                break;
            case 29:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[29];
            ...
            case 30:
                {
                    ...
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[30];
            ...
            case 31:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[31];
            ...
            case 32:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[32];
            ...
            case 33:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[33];
            ...
            case 34:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[34];
            ...
            case 35:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[35];
            ...
            case 36:
                {
                    ...
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[36];
            ...
            case 37:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[37];
            ...
            case 38:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[38];
            ...
            case 39:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[39];
            ...
            case 40:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[40];
            ...
            case 41:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[41];
            ...
            case 42:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Escape))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[42];
            ...
            case 43:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[43];
            ...
            case 44:
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.Space))// 상황에 따라 입력하는 키보드를 바꾼다.
                    {
                        SpaceButton.GetComponent<Image>().sprite = TutorialImage[44];
